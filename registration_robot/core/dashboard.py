...
class dashboard ( wx.Frame ):
	...
	def __init__(self, parent):
		wx.Frame.__init__ ( self, parent, id=wx.ID_ANY, title=constant.REGISTER_NAME , pos=wx.DefaultPosition, size=wx.Size( 900,600 ), style=wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL)
	...
	def InitUI( self ):
		...
		self.SetIcon(wx.Icon( os.path.dirname(sys.argv[0]) + constant.REGISTER_ICON, wx.BITMAP_TYPE_ICO))
		...
		self.m_ip         = wx.StaticText( self, wx.ID_ANY, '', (60,360), wx.DefaultSize, 0 )
		self.setIp()
	...
	def startRegister(self):
		self.AiMaService.start()
	def InitRegisterSeivice(self):
		self.RegisterService = []
		for i in range(constant.AIMA_REGISTER_T_NUM):
