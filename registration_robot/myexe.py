...
class SimpleGrid(gridlib.Grid):
    ...
    def __init__(self, parent):
        ...
        gridlib.Grid.__init__(self, parent, size=(500,500))
        ...
        # overflow cells
        self.SetCellValue( 9, 1, "This default cell will overflow into neighboring cells, but " \
                                 "not if you turn overflow off.");
